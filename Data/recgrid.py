...
tile_width_deg =  0.765598739109 # actual angular degree size width
tile_height_deg = 0.572099528312 # actual angular degree size height
motor_step_deg = 0.75 # motor step size
azimuth_step_deg = 5.0 # azimuth step size
...
with h5py.File(h5_path, "r") as f:
    ...
    for az_idx in range(az_steps):
        for motor_idx in range(motor_steps):
            ...
            rect = patches.Rectangle((motor_deg, azimuth_deg), tile_width_deg, tile_height_deg,
    ...
    for az_idx in range(az_steps):
        for motor_idx in range(motor_steps):
            ...
            motor_deg = motor_idx * motor_step_deg
            azimuth_deg = az_idx * azimuth_step_deg
            extent = [motor_deg, motor_deg + tile_width_deg,azimuth_deg, azimuth_deg + tile_height_deg]
